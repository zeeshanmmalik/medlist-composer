class DrugsController < ApplicationController
  ...
  private
    ...
    def drug_params
      params.require(:drug).permit(:generic_name, :strength, :brand_name, :purpose, :instruction_id, :am_check, :am_time, :noon_check, :noon_time, :supper_check, :supper_time, :bedtime_check, :bedtime_time)
    end
end
